...
singularity run --no-home -B /lus:/lus -B /soft:/soft /lus/theta-fs0/projects/uboone/containers/fnal-wn-sl7_latest.sif <<EOF
  ...
  echo "------------------------------------------------------------------------"
  lar -c /lus/theta-fs0/projects/uboone/kmistry/fcl/run_merge_beamdata.fcl $1 -n1 --nskip $2 -o %ifb_event$2_beamdata.root
  echo "------------------------------------------------------------------------"
  unsetup_all
  ...
  echo "TIMESTAMP_T7 $(date +%s)"
  echo "------------------------------------------------------------------------"
  lar -c /lus/theta-fs0/projects/uboone/kmistry/fcl/reco_uboone_data_mcc9_8_driver_stage1.fcl -s *beamdata.root
  echo "------------------------------------------------------------------------"
  ...
  echo "TIMESTAMP_T7 $(date +%s)"
  echo "------------------------------------------------------------------------"
  lar -c /lus/theta-fs0/projects/uboone/kmistry/fcl/reco_uboone_mcc9_8_driver_data_numi_optical.fcl -s *postdl.root
  echo "------------------------------------------------------------------------"
  lar -c /lus/theta-fs0/projects/uboone/kmistry/fcl/reco_uboone_data_mcc9_8_driver_stage2_beamOn_numi.fcl -s *r1a.root
  echo "------------------------------------------------------------------------"
  lar -c /lus/theta-fs0/projects/uboone/kmistry/fcl/postreco2/reco_uboone_data_mcc9_1_8_driver_poststage2_filters_beamOn_run1_numi.fcl  -s *reco2.root
  echo "------------------------------------------------------------------------"
