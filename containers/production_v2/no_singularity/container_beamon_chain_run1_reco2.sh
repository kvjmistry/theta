...
# USAGE: ./container_beamon_chain_run1_reco2.sh <event num>
...
# reco1a
source /lus/theta-fs0/projects/uboone/containers/timestamp_to_fcl_v2.sh $1 "/lus/theta-fs0/projects/uboone/kmistry/fcl/reco_uboone_mcc9_8_driver_data_numi_optical.fcl" mylist_v27_timestamps.txt

# reco2
source /lus/theta-fs0/projects/uboone/containers/timestamp_to_fcl_v2.sh $1 "/lus/theta-fs0/projects/uboone/kmistry/fcl/reco_uboone_data_mcc9_8_driver_stage2_beamOn_numi.fcl" mylist_v27_timestamps.txt

# postreco2
source /lus/theta-fs0/projects/uboone/containers/timestamp_to_fcl_v2.sh $1 "/lus/theta-fs0/projects/uboone/kmistry/fcl/postreco2/reco_uboone_data_mcc9_1_8_driver_poststage2_filters_beamOn_run1_numi.fcl" mylist_v27_timestamps.txt
...
if [ $SINGULARITYENV_check_bnm == "FileNotFound" ]; then
  ...
  echo "Run time of bnm: $(expr `date +%s` - $start_time) s"
fi
echo "------------------------------------------------------------------------"
if [ $SINGULARITYENV_check_r1a == "FileNotFound" ]; then
  ...
  echo "Run time of reco1a: $(expr `date +%s` - $start_time) s"
fi
echo "------------------------------------------------------------------------"
if [ $SINGULARITYENV_check_reco2 == "FileNotFound" ]; then
  ...
  echo "Run time of reco2: $(expr `date +%s` - $start_time) s"
fi  
echo "------------------------------------------------------------------------"
if [ $SINGULARITYENV_check_larcv == "FileNotFound" ]; then
  ...
  echo "Run time of larcv: $(expr `date +%s` - $start_time) s"
fi
echo "------------------------------------------------------------------------"
if [ $SINGULARITYENV_check_postreco2 == "FileNotFound" ]; then
  ...
  echo "Run time of postreco2: $(expr `date +%s` - $start_time) s"
fi
echo "------------------------------------------------------------------------"
