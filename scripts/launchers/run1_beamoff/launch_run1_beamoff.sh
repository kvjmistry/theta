...
aprun -n $TOTAL_RANKS -N $RANKS_PER_NODE -cc none singularity run -B /opt:/opt/ -B /lus:/lus -B /soft:/soft /lus/theta-fs0/projects/uboone/containers/no_singularity/uboone_singularity_slf7-balsam.sif /lus/theta-fs0/projects/uboone/kmistry/scripts/launchers/run1_beamoff/run1_beamoff_container_wrapper.sh
